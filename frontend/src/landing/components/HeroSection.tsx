    ...
    <section className="relative flex pb-6 md:pb-0 w-full h-screen overflow-hidden bg-gray-900 px-6">
      <div className="w-full flex flex-col items-center justify-center">
        ...
        <motion.div
          ...
          className="mb-6"
        >
          <h1 className="text-5xl sm:text-6xl lg:text-[64px] font-extrabold tracking-tight text-white text-center leading-12 sm:leading-16">
        ...
        >
          <p className="max-w-2xl text-lg sm:text-xl text-gray-400 text-center font-medium tracking-normal leading-8">
            ...
            take notes, and gain valuable insights, all in one platform.
          </p>
        </motion.div>
