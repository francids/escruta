...
const footerLinks: { title: string; links: FooterLink[] }[] = [
  ...
  },
  {
    ...
    links: [
      ...
      // { name: "License", href: `${repoUrl}/blob/main/LICENSE`, external: true },
  ...
  return (
    <footer className="z-[25] relative bg-gray-950 border-t border-gray-800 overflow-hidden">
      <div className="absolute inset-0">
        <div className="absolute inset-0 bg-gradient-to-br from-blue-900/10 via-transparent to-gray-900/20" />
      ...
      <div className="relative z-10">
        <div className="container mx-auto px-6 md:px-24 py-16 md:py-20">
          ...
          <motion.div
            className="pt-8 border-t border-gray-800 flex flex-col md:flex-row items-center space-y-4 md:space-y-0"
            initial={{ opacity: 0 }}
